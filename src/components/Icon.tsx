...
const paths: Record<IconName, React.ReactNode> = {
  ...
  whatsapp: (
    <path d="M3.5 20.5l1.3-4.6A8.4 8.4 0 1 1 8.2 19l-4.7 1.5zm5.2-5.1c1.6 1.6 3.3 2.4 5.1 2.5.6 0 1.2-.3 1.5-.8l.4-.8-2.2-1.2-.8 1a6.6 6.6 0 0 1-2.4-2.4l1-.8L10 11l-.8.4c-.5.3-.8.9-.8 1.5.1 1 .5 1.8 1.3 2.5z" />
  ),
  mail: (
    <>
